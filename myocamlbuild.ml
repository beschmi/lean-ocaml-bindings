(* OASIS_START *)
(* DO NOT EDIT (digest: d38d5eef30c988b665140a960ae76b8e) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("lean_bindings", ["bindings"], []); ("lean", ["lib"], [])];
     lib_c = [("lean", "lib", [])];
     flags =
       [
          (["oasis_library_lean_bindings_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_bindings_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_bindings_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_lean_bindings_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_bindings_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_lean_bindings_native";
              "ocaml";
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S [A "-ccopt"; A "-I"; A "-ccopt"; A "${pkg_ctypes_stubs}"])
            ]);
          (["oasis_library_lean_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lleanshared"])]);
          (["oasis_library_lean_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lleanshared"])]);
          (["oasis_library_lean_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_lean_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_lean_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_lean_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_lean_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_executable_test_lean_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_lean_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_executable_test_lean_native"; "ocaml"; "compile"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])])
       ];
     includes =
